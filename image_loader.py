...
class ImageLoader:
    def __init__(self, parent, is_plotting_sheet, on_images_selected = None, main_gui = None):
        ...
        """
        print(f"DEBUG: Initializing ImageLoader with parent={parent} (is_plotting_sheet={is_plotting_sheet})")
    ...
    def setup_ui(self):
        ...
        print("DEBUG: Attempting UI setup")
    ...
    def add_images(self):
        ...
        print("DEBUG: Opening file dialog for image selection...")
        file_types = [
        ...
        if not new_files:
            print("Debug: No new images selected")
        ...
        print(f"DEBUG: Selected image files: {self.image_files}")
        print(f"Debug: Crop states: {self.image_crop_states}")
        ...
        print("DEBUG: Calling display_images()...")
        self.display_images()
    ...
    def display_images(self):
        ...
        print("DEBUG: Clearing previous image widgets...")
        ...
        print(f"DEBUG: Total images to process: {len(self.image_files)}")
    ...
    def smart_crop(self, img, margin_percent=10):
        ...
        print(f"DEBUG: Running smart_crop on image. Original size: {img.size}")
        ...
        print(f"DEBUG: Selected Bounding Box: (x={x}, y={y}, w={w}, h={h})")
        ...
        print(f"DEBUG: Cropping image with box: {crop_box}")

        cropped_img = img.crop(crop_box)
        print(f"DEBUG: Cropped image size: {cropped_img.size}")
    ...
    def process_image(self, img_path):
        ...
        try:
            ...
            if should_crop:
                print("DEBUG: Auto-Crop was ENABLED at load time. Applying smart_crop.")
                img = self.smart_crop(img, margin_percent=10)
            else:
                print("DEBUG: Auto-Crop was DISABLED at load time. Skipping cropping.")
            ...
            print(f"DEBUG: Resizing image to: ({new_width}, {max_height})")
